...
function App() {
  ...
  // setProducts(products); //<--Evitar la mutabilidad

  console.log("renderixando", products);
  return (
    <div className="center-cotainer">
      ...
      <div className="d-flex justify-content-center align-items-center flex-sm-wrap">
